  ...
  return (
    <section className="flex min-h-screen flex-col items-center px-6 pt-24 text-black 2xl:px-2">
      <div className="z-10 w-full max-w-[1600px] flex-col items-center justify-between text-sm">
        ...
        <div
          className={cn(
            "mt-4 rounded-2xl bg-zkonnect-white-origin p-6",
        ...
        >
          {!hasEnteredMeeting ? (
            ...
            <>
              ...
              <div className="flex h-[70vh] w-full items-stretch justify-between gap-4">
                <div className="flex flex-1 flex-col items-center justify-between">
                  <div className="">
                    <div className="relative flex gap-2">
                      {isVideoOn && (
                        <div className="mx-auto w-full rounded-xl border-2">
                          <video
                            ref={videoRef}
                      ...
                      {isScreenSharing &&
                        new Array(1).fill(0).map((_, i) => (
                          <div
                            className="mx-auto w-1/2 rounded-xl border-2"
                            key={i}
                          >
                            <video
                              ref={screenRef}
                  ...
                  <div className="fixed bottom-0 left-0 z-10 flex h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white lg:static lg:h-fit lg:w-auto lg:bg-none">
                    <>
                      <Button
                        size="default"
                        className={cn(
